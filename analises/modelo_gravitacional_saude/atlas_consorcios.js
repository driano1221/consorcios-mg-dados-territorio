function(el, x, data) {
  ...
  const colors = {destino_clinico_fixo:'#087f8c',estrutura_fixa_nao_clinica:'#c17a13',unidade_movel:'#8747ba',misto:'#374151'};
  ...
  style.textContent += '.leaflet-container{box-sizing:border-box}';
  document.head.appendChild(style);
  document.getElementById('atlas-controls').innerHTML = `
    <div class="eyebrow">IPEA · MINAS GERAIS · REVISÃO DE ${esc(data.date)}</div>
