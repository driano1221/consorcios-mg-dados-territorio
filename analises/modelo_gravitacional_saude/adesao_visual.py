...
<div class="data-layers"><article><h3>CNES corrigido</h3><p>Dois consultórios de pessoa física foram retirados do CISMARG. As quatro estimativas principais ficaram iguais: as unidades tinham zero horas SUS. Rotas e mapas da v1 foram atualizados.</p></article><article><h3>Credores de 2019 conferidos</h3><p>O MIDES sinaliza 17 pares-ano com nome conflitante, dois em 2019. Em São Francisco, os 55 pagamentos somam R$ 188.969,82; 30 objetos citam CISMARG e os demais descrevem saúde ou transporte. O vínculo tem suporte, apesar do nome SOMETAL. Em Conselheiro Pena, os 14 objetos são tributos e radiodifusão; a atribuição ao CISVI foi rejeitada. As métricas acima ainda são do ajuste original.</p></article><article><h3>Mesmo município não garante pagamento</h3><p>Nos 57 pares intramunicipais do S1, 52 pagaram (91,23%), mas a previsão média é 99,07%. Esse excesso de confiança continua aberto.</p></article><article><h3>Diferença de Ipatinga explicada</h3><p>Em 2018, o MIDES soma R$ 567.152,67 sem indicador de restos e R$ 137.077,88 com esse indicador: R$ 704.230,55. A primeira parcela confere com o portal. Falta conferir externamente os restos; isso não explica o zero de 2019. Piedade/2021 também confere, sem resolver 2019.</p></article></div>
<p class="note">Em Neves/2014, dois objetos descrevem monitoramento do prédio da Câmara: R$ 321,16 deixam de ser evidência válida de pagamento ao CISMEP na decisão auditada, sem virar zero anual. Ipatinga e Piedade/2019 não têm o credor procurado nos arquivos SICOM dos 12 meses; a causa permanece aberta. SICOM pode compartilhar origem com MIDES, por isso a conciliação não substitui comprovantes bancários. Bases e estimativas permanecem as originais.</p>
