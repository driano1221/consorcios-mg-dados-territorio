...
**Resultado do passo 3, apos auditoria complementar:** o CNES foi consultado para os 100 CNPJs de matriz e filial por duas rotas: CNPJ mantenedor e CNPJ proprio do estabelecimento. A segunda rota recuperou 15 das 36 entidades antes classificadas como sem unidade direta. O cadastro consolidado possui 670 unidades em 84 entidades.

**Resultado do passo 4, reprocessado:** as 670 unidades foram consultadas nos modulos de ficha, leitos, atendimento e profissionais. Ha 389 unidades fixas e 281 moveis/itinerantes. Sessenta e uma entidades possuem oferta fixa direta, 21 nao possuem unidade direta e duas possuem somente unidades moveis. Cinquenta e oito das 61 com oferta fixa possuem CBO medico SUS ativo; apenas uma possui leitos SUS diretamente registrados. Leitos nao serao usados como massa unica.

**Resultado do passo 5, reprocessado:** a matriz Zenodo/OSRM foi validada por checksum e contem os 363.378 pares internos de MG sem rota ausente. Foram materializadas 203.014 linhas municipio-destino, 331.817 municipio-unidade e 71.652 municipio-entidade. Sessenta e uma entidades possuem tempo disponivel; 21 sem unidade direta e duas somente moveis permanecem `NA`. A fonte e estatica, simetrica, usa sedes municipais IBGE 2010 e nao representa especificamente 10h30 de sabado.
